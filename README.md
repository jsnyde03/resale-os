...
on 2026-09-10**: no CLI, no web app, no dev server. 774 tests green.
...
```bash
npm install
npm run check          # six gates: bytes, imports, phone bundle, plan, types, 774 tests
...
tests/         774 tests; financial logic weighted heaviest
```
