...
on 2026-09-10**: no CLI, no web app, no dev server. 781 tests green.
...
```bash
npm install
npm run check          # six gates: bytes, imports, phone bundle, plan, types, 781 tests
...
tests/         781 tests; financial logic weighted heaviest
```
