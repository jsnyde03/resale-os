...
on 2026-09-10**: no CLI, no web app, no dev server. 757 tests green.
...
```bash
npm install
npm run check          # six gates: bytes, imports, phone bundle, plan, types, 757 tests
...
tests/         757 tests; financial logic weighted heaviest
```
